  ...
  return (
    <div className="relative inline-block md:mt-3">
      <div className="group relative inline-block">
        ...
        <button className="relative bg-secondary text-white font-medium text-sm uppercase px-4 py-2 flex items-center justify-center space-x-2 transition-transform duration-200 transform group-hover:scale-105">
