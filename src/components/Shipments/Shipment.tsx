...
import { Diversity, Reviews, ShipmentImg } from "../../../public/SvgComponent";
...
const Shipment = () => {
  return (
    <div className="max-w-screen-lg mx-auto flex px-4 md:px-8  flex-col md:gap-8 md:flex-row items-start md:items-center justify-between    font-lexend">
      ...
      <Diversity className="text-orange object-cover"/>
      {/* <Image
        src={diversity}
        alt="diversity"
        /> */}
      ...
      <ShipmentImg className="text-orange object-cover"/>
      ...
      <Reviews className="text-orange object-cover"/>
