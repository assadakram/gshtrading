  ...
  return (
    <footer className="bg-black font-lexend py-8  ">
      <div className="max-w-screen-lg mx-auto px-8 gap-10 text-white flex flex-col md:flex-row justify-between">
        ...
        <div className="">
          <h3 className="font-bold text-lg mb-4  whitespace-pre-line">NEWSLETTER</h3>
          <p className=" mb-4  text-sm ">
            Duis aute irure dolor in reprehenderit in <br/> voluptate velit esse cillum dolore eu fugiat <br/>nulla pariatur.
          </p>
          <div className="flex">
          ...
          <button
              type="submit"
              className="bg-purpleCustom px-4 py-2 -mx-1.5 hover:bg-purpleCustom transition font-extrabold">
      ...
      <div className="max-w-screen-lg mx-auto text-center text-white border-t border-gray-700 mt-10 pt-5">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <FaFacebook className="cursor-pointer text-purpleCustom" />
            <FaInstagram className="cursor-pointer text-purpleCustom" />
            <FaLinkedin className="cursor-pointer text-purpleCustom" />
          </div>
        </div>
      </div>
