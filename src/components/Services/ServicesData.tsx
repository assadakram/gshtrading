...
export const ServicesData:Services[] =[
{
  ...
  discription:"We are importers and distributors of our agricultural products of all types. All the products we provide are of high quality and for specific purposes.",
  Image:agriculture,
...
{
  name:"Pigments",
  discription:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since.",
  Image:pigments,
