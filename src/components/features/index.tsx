    ...
    >
      ...
      <div className="flex flex-col gap-4 mt-10 md:mt-0 max-w-md text-center md:text-start">
        ...
        <div className=" flex flex-wrap gap-5 md:mt-4 justify-center md:justify-start">
          <div className="group flex flex-col items-center justify-center w-56 md:w-52 py-3 md:gap-3 gap-2 rounded-lg shadow-custom transform transition-all duration-700 hover:scale-105 hover:shadow-xl hover:bg-primary hover:text-white">
          ...
          <div className="group flex flex-col items-center justify-center w-56 md:w-52 py-3 rounded-xl md:gap-3 gap-2 shadow-custom transform transition-all duration-700 hover:scale-105 hover:shadow-xl hover:bg-primary hover:text-white">
          ...
          <div className="group flex flex-col items-center justify-center w-56 md:w-52 md:gap-3 gap-2 py-3 bg-white rounded-lg shadow-custom transform transition-all duration-700 hover:scale-105 hover:shadow-xl hover:bg-primary hover:text-white">
